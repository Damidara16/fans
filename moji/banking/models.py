...
'''class Wallet(models.Model):
    ...
    stripe_id = models.PositiveIntegerField(default=0)
...
class TransactionHistory(models.Model):
    ...
    def __str__(self):
        return "{} | fan - {} & celeb - {} on {}".format(self.transctionType, self.user.username, self.celeb, self.date)
